...
### c) ii. Remove columns with a single value in all rows
...
# 4. Separate composite columns 

# 5. What issues can you address with this data?

# 6. What do you need to make use of the chemical data?
